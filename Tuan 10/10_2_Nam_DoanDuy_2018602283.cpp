...
void DXOx(float x,float y,float &x1,float &y1)
{
    x1=-x;
    y1=y;
}
...
void khung_ox_oy()
{
    ...
    ChuyenDen2D(xwmax-0.2, 0.2);
    VeDen2D(xwmax,0);
    for(int i=0; i<xwmax;  i++)
    {
        ChuyenDen2D(i,0.1);
        VeDen2D(i,-0.1);
    }
    for(int i=0; i>xwmin; i--)
    {
        ChuyenDen2D(i,0.1);
        VeDen2D(i,-0.1);
    }
...
int main()
{
    initwindow(500,500);
    CuaSo(-3.5,-4,4.5,4);
    KhungNhin(0,0,500,500);
    setcolor(3);
    //rectangle(40,40,400,400);
    khung_ox_oy();
    setcolor(7);
    VeDoThi(-M_PI,-M_PI_2-0.01);
    VeDoThi(-M_PI_2+0.01,M_PI_2-0.01);
    VeDoThi(M_PI_2+0.01,M_PI-0.01);
    setcolor(4);
    VeDoThi1(-M_PI,-M_PI_2-0.01);
    VeDoThi1(-M_PI_2+0.01,M_PI_2-0.01);
    VeDoThi1(M_PI_2+0.01,M_PI-0.01);
